...
from mne_doc_build import report_scraper, reset_warnings  # noqa: E402
...
scrapers = (
    "matplotlib",
    "mne_doc_build.gui_scraper",
    "mne_doc_build.brain_scraper",
    "pyvista",
    "mne_doc_build.report_scraper",
    "mne_doc_build.mne_qt_scraper",
)
...
sphinx_gallery_conf = {
    ...
    "reset_modules": ("matplotlib", "mne_doc_build.mne_ex_resetter"),
